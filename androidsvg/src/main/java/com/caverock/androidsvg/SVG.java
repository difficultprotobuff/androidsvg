...
public class SVG {
   ...
   */
    ...
    public static class Path extends GraphicsElement {
        ...
        public PathDefinition getDefinition() {
            return d;
        }
    ...
    public static abstract class GradientElement extends SvgElementBase implements SvgContainer {
        ...
        public void setGradientUnitsAreUser(Boolean gradientUnitsAreUser) {
            this.gradientUnitsAreUser = gradientUnitsAreUser;
        }
    ...
    public static class SvgRadialGradient extends GradientElement {
        ...
        public void setFx(Length fx) {
            this.fx = fx;
        }

        public void setFy(Length fy) {
            this.fy = fy;
        }
